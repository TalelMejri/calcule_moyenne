...
<div class="hello">
    <section class="py-5 ">
            <div class="container px-lg-5 mt-5">
              <div class="hero text-center row">
                <div id="welcome" class="static_text col-lg-12 fw-bolder">Welcome </div>
                    <ul class="dynamique col-lg-6">
                        <li><span>To</span></li>
                        <li><span>Our</span></li>
                        <li><span>New</span></li>
                ...
                <div class="row py-5 gap-5">
                       ...
                       <div class="col-lg-4 text-center py-5 ">
                           <p style="font-size:22px" class="py-5 fw-bolder">
